...
classifier = cv2.CascadeClassifier(r"C:\Users\ASUS\Desktop\rutu\haarcascade_frontalface_default (1).xml")

model = load_model("fac.h5")

URL = 'http://192.168.221.57:8080/shot.jpg'

def get_pred_label(pred):
    labels = ["harekrishna","ritika","rutendra","sipunn"]
    return labels[pred]
